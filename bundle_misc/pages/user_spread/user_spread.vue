    ...
    <view class="main" v-if="!showLoading">
                ...
                <view class="user-apply-vip column-center">
                    ...
                    <view class="vip-form">
                        ...
                        <view class="form-item bg-white row" style="height: 74px;padding: 24rpx 20rpx 24rpx 30rpx">
                            ...
                            <input type="textarea" v-model="reason" placeholder="（选填）" :custom-style="{paddingLeft: '10rpx'}" :fixed="true" style="flex: 1" />
        ...
        <view :hidden="vipState!=2" class="user-vip">
            ...
            <view class="usual-tools-box bg-white mt20">
                ...
                <navigator hover-class="none" url="/bundle_misc/pages/user_spread_order/user_spread_order" class="usual-item column-center">
                ...
                <navigator hover-class="none" url="/bundle_misc/pages/user_spread_month_bill/user_spread_month_bill" class="usual-item column-center">
