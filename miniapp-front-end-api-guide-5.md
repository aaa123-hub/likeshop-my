...
| shopId | number | 店铺 ID |
| shopName | string | 店铺名 |
| industryId | number | 店铺行业分类 ID |
| industryCode | string | 店铺行业编码，例如 `CATERING` |
| industryName | string | 店铺行业名称，例如 `餐饮` |
| industryFeatureCode | string | 行业功能编码，餐饮为 `SCAN_ORDER`，其他行业通常为 `PRODUCT_UPLOAD` |
| industryFeatureName | string | 行业功能名称，例如 `扫码点餐`、`上传产品` |
...
| shopBase.industryId | number | 店铺行业分类 ID |
| shopBase.industryCode | string | 店铺行业编码，例如 `CATERING` |
| shopBase.industryName | string | 店铺行业名称，例如 `餐饮` |
| shopBase.industryFeatureCode | string | 行业功能编码，餐饮为 `SCAN_ORDER`，其他行业通常为 `PRODUCT_UPLOAD` |
| shopBase.industryFeatureName | string | 行业功能名称，例如 `扫码点餐`、`上传产品` |
