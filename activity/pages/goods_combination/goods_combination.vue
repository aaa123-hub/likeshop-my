...
<template>
	<view class="goods-combination">
		...
		<view class="header">
			<image class="img" src="https://shengyuan.store/api/miniapp/files/miniapp-static/static/images/group_bg.png"></image>
		</view>
						...
						<view class="dec row">
							<view class="group mr20 row">
								<view class="group-img row-center">
									<image class="icon-sm" src="https://shengyuan.store/api/miniapp/files/miniapp-static/static/images/icon_group_white.png"></image>
								</view>
