...
<script>
	...
	import lPainterView from '@/activity/components/lime-painter/components/l-painter-view/l-painter-view.vue'
	import lPainterQrcode from '@/activity/components/lime-painter/components/l-painter-qrcode/l-painter-qrcode.vue'
	export default {
		name: "share-poster",
		components: {
			lPainter,
