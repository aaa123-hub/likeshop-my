...
export default {
  ...
  methods: {
    goBack() {
      ...
      uni.navigateTo({ url: "/bundle/pages/notice/notice" });
    },
  },
};
</script>
...
.notice-detail-shell {
  ...
  margin: 0 auto;
  overflow-x: hidden;
  background: #ffffff url("https://lanhu-oss-proxy.lanhuapp.com/4f9c2d1beb6030110228fe31b5f1167f") 0 0 / 100% 100% no-repeat;
