...
/***/ 86:
/*!************************************************************************************!*\
  !*** /Users/pc/nodejs/likeshop-my-former/main.js?{"page":"pages%2Findex%2Findex"} ***!
  \************************************************************************************/
...
var _index = _interopRequireDefault(__webpack_require__(/*! ./pages/index/index.vue */ 87));
// @ts-ignore
...
/***/ 87:
/*!*****************************************************************!*\
  !*** /Users/pc/nodejs/likeshop-my-former/pages/index/index.vue ***!
  \*****************************************************************/
/*! no static exports found */
...
/* harmony import */ var _index_vue_vue_type_template_id_57280228___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./index.vue?vue&type=template&id=57280228& */ 88);
...
/***/ 88:
/*!************************************************************************************************!*\
  !*** /Users/pc/nodejs/likeshop-my-former/pages/index/index.vue?vue&type=template&id=57280228& ***!
  \************************************************************************************************/
...
/***/ 89:
/*!************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/@dcloudio/vue-cli-plugin-uni/packages/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/webpack-preprocess-loader??ref--17-0!./node_modules/@dcloudio/webpack-uni-mp-loader/lib/template.js!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/webpack-uni-app-loader/page-meta.js!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/vue-loader/lib??vue-loader-options!./node_modules/@dcloudio/webpack-uni-mp-loader/lib/style.js!/Users/pc/nodejs/likeshop-my-former/pages/index/index.vue?vue&type=template&id=57280228& ***!
  \************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
/*! exports provided: render, staticRenderFns, recyclableRender, components */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var render = function () {
  ...
  var l0 = _vm.__map(_vm.shortcutList, function (item, index) {
    var $orig = _vm.__get_orig(item)
    var m0 = _vm.isEmptyImage(item.image)
    var m1 = !m0 ? _vm.displayImage(item.image) : null
    return {
      $orig: $orig,
      m0: m0,
      m1: m1,
  ...
  var g1 = _vm.recentVisitList.length
  var g2 = _vm.recentVisitList.length
  var l1 = g2
    ? _vm.__map(_vm.recentVisitList, function (item, index) {
        var $orig = _vm.__get_orig(item)
        var m2 = _vm.isEmptyImage(item.cover)
        var m3 = !m2 ? _vm.displayImage(item.cover) : null
        return {
          $orig: $orig,
          m2: m2,
          m3: m3,
    ...
    : null
  var g3 = _vm.hotActivityList.length
  var g4 = _vm.hotActivityList.length
  var l2 = g4
    ? _vm.__map(_vm.hotActivityList, function (item, index) {
        var $orig = _vm.__get_orig(item)
        var m4 = _vm.isEmptyImage(item.cover)
        var m5 = !m4 ? _vm.displayImage(item.cover) : null
        return {
          $orig: $orig,
          m4: m4,
          m5: m5,
    ...
    : null
  var g5 = _vm.recommendedProductList.length
  var g6 = _vm.recommendedProductList.length
  var l3 = g6
    ? _vm.__map(_vm.recommendedProductList, function (item, index) {
        var $orig = _vm.__get_orig(item)
        var m6 = _vm.isEmptyImage(item.image || item.goods_image)
        var m7 = !m6
          ? _vm.displayImage(item.image || item.goods_image, "goods")
          : null
        return {
          $orig: $orig,
          m6: m6,
    ...
    : null
  var g7 = _vm.recommendedShopList.length
  var g8 = _vm.recommendedShopList.length
  var l4 = g8
    ? _vm.__map(_vm.recommendedShopList, function (item, index) {
        var $orig = _vm.__get_orig(item)
        var m8 = _vm.isEmptyImage(_vm.getShopImage(item))
        var m9 = !m8 ? _vm.displayImage(_vm.getShopImage(item)) : null
        return {
          $orig: $orig,
          m8: m8,
          m9: m9,
...
/***/ 90:
/*!******************************************************************************************!*\
  !*** /Users/pc/nodejs/likeshop-my-former/pages/index/index.vue?vue&type=script&lang=js& ***!
  \******************************************************************************************/
/*! no static exports found */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/***/ 91:
/*!*************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/webpack-preprocess-loader??ref--13-1!./node_modules/@dcloudio/webpack-uni-mp-loader/lib/script.js!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/vue-loader/lib??vue-loader-options!./node_modules/@dcloudio/webpack-uni-mp-loader/lib/style.js!/Users/pc/nodejs/likeshop-my-former/pages/index/index.vue?vue&type=script&lang=js& ***!
  \*************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
var _businessRoutes = __webpack_require__(/*! @/utils/business-routes */ 93);
...
var _default = {
  data: function data() {
    return {
      ...
      businessRoutes: _businessRoutes.businessRoutes,
      homeLoaded: false
    };
  },
  computed: _objectSpread(_objectSpread({}, (0, _vuex.mapGetters)(['userInfo'])), {}, {
    ...
    walletBalanceText: function walletBalanceText() {
      var _this$homeData$wallet;
      var balance = (_this$homeData$wallet = this.homeData.walletCard) === null || _this$homeData$wallet === void 0 ? void 0 : _this$homeData$wallet.balance;
      var value = balance !== undefined && balance !== null ? balance : this.userInfo.user_money;
      return Number(value || 0).toFixed(2);
    },
    quickEntryList: function quickEntryList() {
      var _this = this;
      var source = this.homeData.quickEntries || [];
      var list = source.map(function (item) {
        return _this.normalizeQuickEntry(item);
      }).filter(Boolean);
      return list.length ? list : this.homeShortcutFallback;
    },
    bannerList: function bannerList() {
      return (this.homeData.banners || []).map(function (item, index) {
        return _objectSpread(_objectSpread({}, item), {}, {
          image: (0, _imagePlaceholder.resolveImage)(item.image || item.imageUrl || item.cover || item.pic || item.banner),
          url: item.url || item.link || item.jumpUrl || '',
          type: item.type || item.linkType || item.jumpType || '',
          title: item.title || item.name || "banner-".concat(index),
    ...
    recentVisitList: function recentVisitList() {
      return this.homeData.recentVisits || [];
    },
    hotActivityList: function hotActivityList() {
      return this.homeData.hotActivities || [];
    },
    recommendedProductList: function recommendedProductList() {
      return this.homeData.recommendedProducts || [];
    },
    recommendedShopList: function recommendedShopList() {
      return this.homeData.recommendedShops || [];
    },
    homeShortcutFallback: function homeShortcutFallback() {
      return [{
        name: '分类',
        image: '',
        url: '/pages/sort/sort',
        ...
        name: '活动',
        image: '',
        url: '/business/pages/business_pages/activity_center'
      }, {
        name: '门店',
        image: '',
  ...
  onPullDownRefresh: function onPullDownRefresh() {
    this.getHomeFun().finally(function () {
      uni.stopPullDownRefresh();
    });
  },
  methods: {
    getHomeFun: function getHomeFun() {
      var _this2 = this;
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _context.prev = 0;
                _context.next = 3;
                return (0, _store.getHome)(_this2.buildHomeParams());
              case 3:
                res = _context.sent;
                if (res.code == 1) {
                  _this2.homeData = res.data || {};
                  _this2.homeLoaded = true;
                }
                _context.next = 9;
                break;
              case 7:
    ...
    resolveImage: _imagePlaceholder.resolveImage,
    ...
    displayImage: function displayImage(src) {
      var type = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 'common';
      return (0, _imagePlaceholder.resolveImage)(src, type);
    },
    getShopImage: function getShopImage() {
      var item = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
      return item.shopLogo || item.logo || item.logoUrl || item.image || item.cover || item.avatarUrl || item.shopImage || item.shopPic || '';
    },
    buildHomeParams: function buildHomeParams() {
      var _this$userInfo$lat, _this$userInfo$lng;
      var lat = (_this$userInfo$lat = this.userInfo.lat) !== null && _this$userInfo$lat !== void 0 ? _this$userInfo$lat : this.userInfo.latitude;
      var lng = (_this$userInfo$lng = this.userInfo.lng) !== null && _this$userInfo$lng !== void 0 ? _this$userInfo$lng : this.userInfo.longitude;
      var params = {
        pageScene: 'HOME',
    ...
    normalizeQuickEntry: function normalizeQuickEntry() {
      var item = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
      var code = String(item.code || '').toUpperCase();
      var quickEntryMap = {
        CATEGORY: {
          name: item.title || '分类',
          image: (0, _imagePlaceholder.resolveImage)(item.iconUrl || ''),
    ...
    openBusinessPage: function openBusinessPage(item) {
      (0, _businessRoutes.openBusinessRoute)(item);
    },
    handleBannerTap: function handleBannerTap(item) {
      if (item.url) {
      ...
      if (item.scene && _businessRoutes.businessRoutes.pages[item.scene]) {
        (0, _businessRoutes.openBusinessRoute)(_businessRoutes.businessRoutes.pages[item.scene]);
      }
    },
    handleVisitTap: function handleVisitTap(item) {
      if ((item.visitType || '').toUpperCase() === 'SHOP' && item.targetId) {
        this.goPage("/business/pages/business_pages/store_detail?shopId=".concat(item.targetId));
        return;
      }
      if (item.targetId) {
        this.goPage("/bundle/pages/goods_details/goods_details?id=".concat(item.targetId));
      }
    },
    handleActivityTap: function handleActivityTap(item) {
      if (item.targetId) {
        this.goPage("/activity/pages/activity_detail/activity_detail?id=".concat(item.targetId));
        return;
      }
      this.openBusinessPage(_businessRoutes.businessRoutes.pages.activityCenter);
    },
    handleShopTap: function handleShopTap(item) {
      this.goPage("/business/pages/business_pages/store_detail?shopId=".concat(item.shopId || item.id || ''));
    },
    openShortcut: function openShortcut(item) {
      if (item.type === 'switchTab') {
        this.switchTab(item.url);
        return;
      }
      ...
      var code = String(item.code || item.name || '').toUpperCase();
...
/***/ 94:
/*!***************************************************************************************************!*\
  !*** /Users/pc/nodejs/likeshop-my-former/pages/index/index.vue?vue&type=style&index=0&lang=scss& ***!
  \***************************************************************************************************/
/*! no static exports found */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/***/ 95:
/*!*******************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/mini-css-extract-plugin/dist/loader.js??ref--8-oneOf-1-0!./node_modules/css-loader/dist/cjs.js??ref--8-oneOf-1-1!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/webpack-preprocess-loader??ref--8-oneOf-1-2!./node_modules/postcss-loader/src??ref--8-oneOf-1-3!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/sass-loader/dist/cjs.js??ref--8-oneOf-1-4!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/webpack-preprocess-loader??ref--8-oneOf-1-5!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/vue-loader/lib??vue-loader-options!./node_modules/@dcloudio/webpack-uni-mp-loader/lib/style.js!/Users/pc/nodejs/likeshop-my-former/pages/index/index.vue?vue&type=style&index=0&lang=scss& ***!
  \*******************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
